...
- Mission tests must use the dedicated **test schema** named `opentoggl_test` in the shared PostgreSQL service; never point mission tests at the development or production business schema.
