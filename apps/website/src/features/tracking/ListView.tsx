...
type ListViewProject = import("./TimeEntryEditorDialog.tsx").TimeEntryEditorProject;
type ListViewTag = import("./TimeEntryEditorDialog.tsx").TimeEntryEditorTag;

const ListGroupSection = memo(function ListGroupSection({
  durationFormat,
  expandedGroupKeys,
  group,
  isGroupFullySelected,
  ...
  durationFormat: import("./overview-data.ts").DurationFormat;
  ...
  tags: ListViewTag[];
  timeofdayFormat: import("./overview-data.ts").TimeFormat;
  timezone: string;
