...
description: Implante o OpenToggl na sua própria infraestrutura com Docker Compose, CasaOS, Synology, fnOS e mais.
---
...
O [CasaOS](https://casaos.io) suporta a instalação de apps a partir de um arquivo Docker Compose.
