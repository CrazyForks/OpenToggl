...
<Callout type="warn">
  Em produção, sempre troque as duas senhas. Os valores padrão servem apenas para testes locais. Mesmo que o Postgres/Redis
  não exponham portas ao host, definir uma senha é o mínimo de defesa contra invasões na rede interna.
</Callout>
