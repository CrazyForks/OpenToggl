...
func TestGeneratedWebClientsRoutesRejectInvalidQueryAndBody(t *testing.T) {
	server := echo.New()
	registerGeneratedWebClientsRoutes(server, &generatedWebClientsHandlerStub{})
...
func TestGeneratedWebClientsRoutesDecodeListQuery(t *testing.T) {
	server := echo.New()
	handler := &generatedWebClientsHandlerStub{}
	registerGeneratedWebClientsRoutes(server, handler)
...
type generatedWebClientsHandlerStub struct {
	listRequest *GeneratedListClientsRequest
}

func (stub *generatedWebClientsHandlerStub) ListClients(
	_ context.Context,
	_ string,
...
func (*generatedWebClientsHandlerStub) CreateClient(
	context.Context,
	string,
