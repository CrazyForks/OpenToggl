...
| Transport Contract      | 公开 API 与错误语义                        | `apps/backend/tests/public-contract/**`                             | 路径、字段、状态码、错误映射   |
...
| Public Contract Golden | Toggl 公开合同基线                         | `apps/backend/tests/golden/**`                                      | JSON shape、导出/报表基线      |
