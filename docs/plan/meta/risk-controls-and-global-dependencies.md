...
- Derived from `## 9. 统一依赖关系`, `## 10. 风险与控制策略`, and `## 11. 完成定义` in [`2026-03-20-opentoggl-full-implementation-plan.md`](/Users/ctrdh/Code/opentoggl/docs/plan/2026-03-20-opentoggl-full-implementation-plan.md)
