...
- Derived from `## 4. 强制执行模型：Subagent-Driven Delivery` and `## 12. 执行备注` in [`2026-03-20-opentoggl-full-implementation-plan.md`](/Users/ctrdh/Code/opentoggl/docs/plan/2026-03-20-opentoggl-full-implementation-plan.md)
